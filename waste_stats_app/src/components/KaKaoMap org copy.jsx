    ...
    const loadMap = () => {
      window.kakao.maps.load(() => {
        ...
        const markers = positions.map((pos) => {
          ...
          const shouldAnimate = pos.address && pos.address.length > 10; // 길이 기준은 필요 시 조정
          const shouldAnimateProductName = pos.product_name && pos.product_name.length > 10; // 품목 애니메이션 기준
