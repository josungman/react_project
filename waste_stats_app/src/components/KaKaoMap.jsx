      ...
      if (window.kakao && window.kakao.maps) {
        window.kakao.maps.load(() => {
          ...
          const markerImage = new window.kakao.maps.MarkerImage(
            "/marker-icon.png", // ✅ public 폴더에 넣은 커스텀 마커 이미지
    ...
    <div className="flex flex-col h-full overflow-hidden relative">
      ...
      {nearbyList.length > 0 && (
        <div className="absolute top-[60px] left-2 bg-white shadow pl-2 rounded max-h-[240px] w-[260px] overflow-y-auto z-20 text-sm">
          <div className="sticky top-0 bg-white z-10 py-2 border-b font-semibold">📍 반경 5km 업체 ({nearbyList.length}개) 클릭 가능</div>
